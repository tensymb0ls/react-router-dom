...
const Aside = (props) => {
    const { user } = props;
    return (
        <div className='flex flex-col  gap-[10px] p-[10px] m-[10px] rounded-[15px] bg-[#fff] shadow-componentshadow text-colorTextBlack text-contentSize leading-[18px] w-[240px]'>
